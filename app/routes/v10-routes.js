...
router.get('/v10/04-do-any-beneficial-owners-or-managing-officers-have-their-personal-information-protected-at-companies-house', function(req, res) {
  if (req.session.data['saved-filing'] === 'yes') {
    res.render('v10/03-your-filings')
  } else {
    res.render('v10/04-do-any-beneficial-owners-or-managing-officers-have-their-personal-information-protected-at-companies-house')
  }
})
...
// 04 ******* PROTECTED FILTER *******
router.get('/v10/06-are-there-any-trusts-involved-in-this-overseas-entity', function(req, res) {
  if (req.session.data['secure-register'] === 'yes') {
    res.render('v10/05-youll-need-to-file-an-update-statement-using-the-paper-form')
  } else {
    res.render('v10/06-are-there-any-trusts-involved-in-this-overseas-entity')
  }
})


// 06 ******* TRUSTS INVOLVED FILTER *******
router.get('/v10/08-before-you-start', function(req, res) {
  if (req.session.data['trust-involved'] === 'yes') {
    res.render('v10/07-youll-need-to-file-an-update-statement-using-the-paper-form')
  } else {
    res.render('v10/08-before-you-start')
  }
})
...
router.get('/v10/19-who-is-completing-this-update', function(req, res) {
  if (req.session.data['make-changes'] === 'no') {
    res.render('v10/15b-has-the-overseas-entity-identified-any-registrable-beneficial-owners')
  } else {
    res.render('v10/19-who-is-completing-this-update')
  }
})
...
router.get('/v10/14-do-you-need-to-make-any-changes-to-this-overseas-entity', function(req, res) {
  if (req.session.data['need-to-change'] === 'yes') {
    res.render('v10/xx-payment') 
  } else {
    res.render('v10/14-do-you-need-to-make-any-changes-to-this-overseas-entity')
  }
})
...
router.get('/v10/21-tell-us-about-the-uk-regulated-agent-that-carried-out-verification-checks', function(req, res) {
  if (req.session.data['who-is-filing'] === 'agent') {
    res.render('v10/20-complete-this-statement-to-confirm-that-verification-checks-have-been-completed')
  } else {
    res.render('v10/21-tell-us-about-the-uk-regulated-agent-that-carried-out-verification-checks')
  }
})
...
router.get('/v10/submit-pay/check-your-answers', function(req, res) {
  if (req.session.data['bo-update-ceased'] === 'yes') {
    res.render('v10/statements-concept/xx-change-statements-generic')
  } else {
    res.render('v10/submit-pay/check-your-answers')
  }
})
...
router.get('/v10/oe-details', function (req, res) {
  // Set URl
  res.render('v10/oe-details', {
    currentUrl: req.originalUrl
  })
})

router.post('/v10/oe-details', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (req.session.data['entity-email'] == '') {
    ...
    res.redirect('/v10/beneficial-owner/bo-mo-review')
  }
})
...
router.get('/v10/trusts/individual', function (req, res) {
  // Set URl
  res.render('v10/trusts/individual', {
    currentUrl: req.originalUrl
  })
})

router.post('/v10/trusts/individual', function (req, res) {
  res.redirect('/v10/trusts/individual-2')
})


// ******* individual-2 validation ********************************
router.get('/v10/trusts/individual-2', function (req, res) {
  // Set URl
  res.render('v10/trusts/individual-2', {
    currentUrl: req.originalUrl
  })
})

router.post('/v10/trusts/individual-2', function (req, res) {
  res.redirect('/v10/trusts/legal-entity')
})


// ******* legal-entity validation ********************************
router.get('/v10/trusts/legal-entity', function (req, res) {
  // Set URl
  res.render('v10/trusts/legal-entity', {
    currentUrl: req.originalUrl
  })
})

router.post('/v10/trusts/legal-entity', function (req, res) {
  res.redirect('/v10/trusts/trust-involved-additions')
})
...
router.get('/v10/beneficial-owner/bo-individual', function (req, res) {
  // Set URl
  res.render('v10/beneficial-owner/bo-individual', {
    currentUrl: req.originalUrl
  })
})

router.post('/v10/beneficial-owner/bo-individual', function (req, res) {
  // Create variables
  ...
  // Re-show page with error value as true so errors will show
    ...
    // User inputted value so move to next page
    res.redirect('/v10/beneficial-owner/mo')
  }
})
...
// ******* bo gov validation ********************************
router.get('/v10/beneficial-owner/bo-gov', function (req, res) {
  // Set URl
  res.render('v10/beneficial-owner/bo-gov', {
    currentUrl: req.originalUrl
  })
})
router.post('/v10/beneficial-owner/bo-gov', function (req, res) {
  // Create variables
  var boCeasedError = false;
...
router.get('/v10/beneficial-owner/mo', function (req, res) {
  // Set URl
  res.render('v10/beneficial-owner/mo', {
    currentUrl: req.originalUrl
  })
})

router.post('/v10/beneficial-owner/mo', function (req, res) {
  // Create variables
  var propertyError = false;
  var address1Error = false;
  var cityError = false;
  ...
  // Re-show page with error value as true so errors will show
    ...
    // User inputted value so move to next page
    res.redirect('/v10/beneficial-owner/involved-types')
  }
})
...
router.get('/v10/trusts/trust-details', function (req, res) {
  // Set URl
  res.render('v10/trusts/trust-details', {
    currentUrl: req.originalUrl
  })
})

router.post('/v10/trusts/trust-details', function (req, res) {
  ...
  if (errors.length != 0) {
    ...
    res.redirect('/v10/trusts/former-bo')}
})


// ******* delete-trust-warning validation ********************************
router.get('/v10/trusts/delete-trust-warning', function (req, res) {
  // Set URl
  res.render('v10/trusts/delete-trust-warning', {
    currentUrl: req.originalUrl
  })
})

router.post('/v10/trusts/delete-trust-warning', function (req, res) {
  ...
  if (warningAnswer == "yes"){
    ...
    res.redirect('/v10/trusts/add-trust-deleted')
  } else {
    // Send user to ineligible page
    res.redirect('/v10/trusts/trust-details')
  }
...
router.get('/v10/trusts/former-bo', function (req, res) {
  // Set URl
  res.render('v10/trusts/former-bo', {
    currentUrl: req.originalUrl
  })
})

router.post('/v10/trusts/former-bo', function (req, res) {
  ...
  if (errors.length != 0) {
    ...
    // User inputted value so move to next page
    res.redirect('/v10/trusts/individual')
  }
